...
labevents_tble <- tbl(con_bq, "labevents") |>
  ...
  filter(!is.na(storetime), storetime <= intime) |>
  group_by(stay_id, subject_id, hadm_id, itemid) |>
  ...
  select(stay_id, subject_id, hadm_id, label, valuenum) |>
  collect() |>
...
vitals_first_wide <- tbl(con_bq, "chartevents") |>
  transmute(
