...
labevents_tble <- tbl(con_bq, "labevents") |>
  ...
  ungroup() |>
  select(subject_id, hadm_id, stay_id, label, value) |>
  collect() |>
  mutate(label = str_replace_all(label, "[^A-Za-z0-9]+", "_")) |>
  pivot_wider(
    names_from = label,
    values_from = value
  ) |>
...
chartevents_tble <- tbl(con_bq, "chartevents") |>
  ...
  slice_min(order_by = storetime, n = 1, with_ties = FALSE) |>
  ungroup() |>
