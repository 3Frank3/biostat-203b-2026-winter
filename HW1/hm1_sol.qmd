...
```
**Solution to Q3:**
- `zcat`: zcat outputs the contents of a gzip-compressed file to standard output without uncompressing it to disk.
- `zless`: zless uses less to view the contents of gzip-compressed files interactively
