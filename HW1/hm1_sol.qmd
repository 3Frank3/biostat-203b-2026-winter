...
ls -l ~/mimic/Sphysionet.org/files/mimiciv/3.1
...
contents of gzip-compressed files interactively. - `zmore`: Similar to
`zless`, displays the contents of a gzip-compressed file page by page
using more. - `zgrep`: Displays the contents of a gzip-compressed file
