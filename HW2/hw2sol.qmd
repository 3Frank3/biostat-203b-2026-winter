...
read_csv_time <- system.time({
  admissions_read_csv <- read.csv(gzfile("~/mimic/hosp/admissions.csv.gz"))
})
# read.csv in tidyverse
read_csv_time <- system.time({
  admissions_read_csv <- read_csv(gzfile("~/mimic/hosp/admissions.csv.gz"))
})
# fread in data.table  
fread_time <- system.time({
  admissions_fread <- fread(gzfile("~/mimic/hosp/admissions.csv.gz"))
})
