...
transfers <- read_csv("~/mimic/hosp/transfers.csv.gz") |> 
  filter(subject_id == subj_id)
diag <- read_csv("~/mimic/hosp/diagnoses_icd.csv.gz") |>
  filter(subject_id == subj_id)
d_diag <- read_csv("~/mimic/hosp/d_icd_diagnoses.csv.gz")
proc <- read_csv("~/mimic/hosp/procedures_icd.csv.gz") |>
  filter(subject_id == subj_id)
d_proc <- read_csv("~/mimic/hosp/d_icd_procedures.csv.gz")
